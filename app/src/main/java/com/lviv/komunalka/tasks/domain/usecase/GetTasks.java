...
package com.lviv.komunalka.tasks.domain.usecase;
...
import com.lviv.komunalka.tasks.TasksFilterType;
import com.lviv.komunalka.tasks.domain.filter.FilterFactory;
import com.lviv.komunalka.tasks.domain.filter.TaskFilter;
